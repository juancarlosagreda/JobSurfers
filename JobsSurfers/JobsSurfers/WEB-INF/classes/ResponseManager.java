...
public class ResponseManager extends HttpServlet {
    ...
    public static void outputUWP (HttpServletResponse res, String user, String message)  throws IOException {
        ...
        toClient.println("<li class=\"dropdown\"><a href=\"#\" class=\"dropdown-toggle\" data-toggle=\"dropdown\" role=\"button\" aria-haspopup=\"true\" aria-expanded=\"false\">"+user+"'s Account <span class=\"caret\"></span></a><ul class=\"dropdown-menu\"><li><a href=\"#\">View Profile</a></li><li role=\"separator\" class=\"divider\"></li><li><a href=\"FindGroups\">Groups</a></li><li role=\"separator\" class=\"divider\"></li><li><a href=\"#\">Sign Out</a></li><li><a href=\"#\">Delete Account</a></li></ul></li></ul></div></div></nav>");
        toClient.println(message);
        toClient.println("</body></html>");
    }   
}