...
public class GetGI extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        String html="<div id=\"content\"><h2 class=\"title\">Group Invitations</h2><div id=\"notification\"></div>";
        ...
        try {
            ...
            while(result.next()) {
                ...
                html += "<li><a href=\"#\">" + group + "</a><span class=\"buttons\"><button type=\"button\" class=\"btn btn-primary\" onclick=\"Join(this, "+id+", '"+group+"'); emptyList('You have no more group invitations for now.')\">Accept</button><button type=\"button\" class=\"btn btn-primary\">Decline</button></span></li>";
            }
