...
public class ResponseManager extends HttpServlet {
	...
	public static void AjaxOutput (HttpServletResponse res, String message)  throws IOException {
		...
		public static void outputUWOP (HttpServletResponse res, String user, String message)  throws IOException {
	        ...
	        toClient.println("<li class=\"dropdown\"><a href=\"#\" class=\"dropdown-toggle\" data-toggle=\"dropdown\" role=\"button\" aria-haspopup=\"true\" aria-expanded=\"false\">Jobs <span class=\"caret\"></span></a><ul class=\"dropdown-menu\"><li><a href=\"\">Apply for a job</a></li><li role=\"separator\" class=\"divider\"></li><li><a href=\"MyJobs\">See Applications' Status</a></li></ul></li>");
